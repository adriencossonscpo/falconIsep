...
public class WelcomeTeacherController {
	...
	public String displayModule(HttpServletRequest request,Model model){
    	...
    	if(((UserAvis) request.getSession().getAttribute("userLogged")).getRole().name().equalsIgnoreCase(Role.ROLE_VTEACHER.name())){
