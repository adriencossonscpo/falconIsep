INSERT INTO public.user_avis(
	user_type, id, email, first_name, last_name, login, passwd, promo)
	VALUES ('ROLE_ADMIN', 0000000000, 'admin@avisep.fr', 'Mister', 'Admin', 'adminavisep', 'falconteamadmin', 1970),
	('ROLE_ETEACHER', 0000000001, 'teacher1@avisep.fr', 'Miss', 'Teacher', 'teacheravisep1', 'falconteamteacher1', 1971),
	('ROLE_STUDENT', 0000000002, 'acosson@avisep.fr', 'Adrien', 'Cosson', 'adriencosson', 'adrienfalcon', 2018),
	('ROLE_STUDENT', 0000000003, 'psimao@avisep.fr', 'Pedro', 'Simao', 'pedrosimao', 'pedrofalcon', 2018),
	('ROLE_STUDENT', 0000000004, 'aquinq@avisep.fr', 'Antoine', 'Quinquenel', 'aquinq', 'antoinefalcon', 2019),
	('ROLE_VTEACHER', 0000000005, 'teacher2@avisep.fr', 'Mister', 'Teacher', 'teacheravisep2', 'falconteamteacher2', 1972);


INSERT INTO public.user_avis_role_avis(
	user_avis_id, role_avis)
...
INSERT INTO public.salle(
	salle_id, location, name, cours_coursid)
...
INSERT INTO public.cours(
	cours_id, c_date, description, module_moduleid)
...
INSERT INTO public.template(
	tem_id, name)
	VALUES (8000000000, 'For Professor'),
	(8000000001, 'For Course');
